...
const SignUpId = ({ handleSubmitPassword, passwordRegex, errorPass }) => {
  ...
  return (
    <div className="flex flex-col gap-8 items-center justify-center">
      <h1 className="text-white font-bold text-2xl">Enter your password</h1>
      <form
      ...
      >
        ...
        />
        {!!errorPass ? <span className="text-white">{errorPass}</span> : null}
        <button
